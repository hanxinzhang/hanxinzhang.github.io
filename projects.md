...
A diagnosis EHR, which we refer to as a "sentence", is composed of tens of repeating segment (a "word") \{\texttt{Diagnosis code:Age:Time}\}. It worth noting some characteristics of the medical code sentence:
