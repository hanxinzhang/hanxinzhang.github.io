...
A diagnosis EHR, which we refer to as a "sentence", is composed of tens of repeating segment (each a "word" of the form ```
Diagnosis code:Age:Time
```
). It is worth noting several key characteristics of this medical code sentence:
